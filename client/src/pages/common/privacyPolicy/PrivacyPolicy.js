...
export default () => {
    return (
        <Layout className='home layout'>
            ...
            <Content>
                <Card>
                    <a href='https://www.privacypolicygenerator.info/live.php?token=C1drSZIlSpuOeOF5DHeWICaPx4433aWV'>Privacy Policy Registration Original Link</a>

                    <h1>Privacy Policy for IFSU</h1>

                    <p>At IFSU ATTENDANCE, accessible from https://ifsuattendance.netlify.app/, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by IFSU ATTENDANCE and how we use it.</p>

                    <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>

                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in IFSU ATTENDANCE. This policy is not applicable to any information collected offline or via channels other than this website.</p>
                    ...
                    <p>Like any other website, IFSU ATTENDANCE uses "cookies". These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
